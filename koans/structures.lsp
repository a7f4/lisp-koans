...
(defstruct (nba-contract (:include basketball-player ) (:conc-name nba-)) salary start-year end-year)
...
(define-test test-structure-extension
    (let ((contract-1 (make-nba-contract
                       ...
                       :team :LAKERS
                       :number 24)))
      (assert-equal 2004 (nba-start-year contract-1))
      ...
      (assert-equal :LAKERS (nba-team contract-1))
